<?php
	...
	$usernameErr = $passwordErr = $password2Err = $firstnameErr = $lastnameErr = $add1Err = $add2Err = "";
	$cityErr = $stateErr = $zipcodeErr = $phoneNoErr = $emailErr = $genderErr = $maritalstatusErr = $dobErr = "";
	
	//variable for each field input
	$uname = $password = $password2 = $firstname = $lastname = $add1 = $add2 = $city = "";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (empty($firstname)) {
			...
			{
				$firstnameErr = "Max length of 50 characters";
				$isValid = false;
			}
		}
